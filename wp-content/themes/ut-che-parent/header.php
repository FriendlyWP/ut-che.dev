...
<body <?php body_class(); ?>>
		...
		<header id="header">
            <div class="wrap">
                ...
                <div class="main-head clearfix"><a href="<?php echo bloginfo('url'); ?>"><img src="<?php bloginfo('template_directory'); ?>/_/images/che-logo-new.png" alt="McKetta Department of Chemical Engineering" title="McKetta Department of Chemical Engineering" /></a><div class="search">
